...
import com.xingyun.equipment.admin.modular.remotesetting.model.*;
import com.xingyun.equipment.admin.modular.remotesetting.service.*;
 ...
 */
@RestController
@RequestMapping("/ssdevice/remoteSetting/deviceLog")
