...
public class GetFlow {
    ...
    public String getCtdSMSUsage() {
        return ctdSMSUsage;
    }

    public void setCtdSMSUsage(String ctdSMSUsage) {
        this.ctdSMSUsage = ctdSMSUsage;
    }

    public String getCtdVoiceUsage() {
        return ctdVoiceUsage;
    }

    public void setCtdVoiceUsage(String ctdVoiceUsage) {
