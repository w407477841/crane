...
import com.xingyun.equipment.admin.core.util.CreateExcel;
import com.xingyun.equipment.admin.core.util.ProducerUtil;
import com.xingyun.equipment.admin.modular.device.dao.ProjectCraneFileMapper;
import com.xingyun.equipment.admin.modular.device.dao.ProjectCraneStatisticsDailyMapper;
import com.xingyun.equipment.admin.modular.device.dto.ProjectCraneStaticsticsByDateDTO;
import com.xingyun.equipment.admin.modular.device.model.*;
...
import com.xingyun.equipment.admin.modular.device.dao.ProjectCraneVideoMapper;
...
//        //针对文件
    ...
    public ResultDTO<ProjectCraneDetailVO> selectCraneDetail(RequestDTO request) {
        ...
        String key = RedisConfig.DEVICE_CURRENT+crane.getProjectId()+":crane:"+crane.getDeviceNo();
        if(redisUtil.exists(key)){
            log.info("存在 key:{}",key);
