...
import com.xingyun.equipment.admin.modular.device.vo.SendMessageDTO;
...
public class MessageController {
    ...
    @PostMapping(value="ssdevice/message/sendMessage")
    ...
    @PostMapping("ssdevice/message/userList")
