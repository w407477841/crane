package com.xywg.equipment.monitor.iot.modular.alipush.service;
...
import com.xywg.equipment.monitor.iot.config.AliConfig;
    ...
    public void pushMob( String title,String body ,String uuid){
        if(aliConfig.isOpen()){
            try {
                ...
                System.out.println(title+"__移动端推送异常");
                e.printStackTrace();
            }
        }
    }
