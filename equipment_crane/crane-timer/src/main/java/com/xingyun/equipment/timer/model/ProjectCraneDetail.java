...
public class ProjectCraneDetail extends Model<ProjectCraneDetail> {
	...
	public ProjectCraneDetail(Integer craneId, String deviceNo, Integer driver, Date deviceTime, Integer status, Double weight,Double safetyWeight, Double moment,Double safetyMoment, Double height, Double range, Double momentPercentage, Double rotaryAngle, Double tiltAngle, Double windSpeed, Integer isDel, Date createTime) {
