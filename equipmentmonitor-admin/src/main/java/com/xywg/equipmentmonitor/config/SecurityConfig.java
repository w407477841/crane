...
import com.xywg.equipmentmonitor.core.security.filter.JWTAuthenticationFilter;
import com.xywg.equipmentmonitor.core.security.filter.JWTLoginFilter;
import com.xywg.equipmentmonitor.core.security.provider.UsernameAuthenticationProvider;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers(HttpMethod.POST, "/users").antMatchers("/", "/auth/**", "/resources/**",
				...
				// 安全帽接口
				.antMatchers("/ssdevice/health/userListinfo")
				.antMatchers("/ssdevice/device/helmet/getwechatInfo")
				.antMatchers("/ssdevice/device/helmet/bindWechat")
				.antMatchers("/ssdevice/device/helmet/updateWechat")
				// 喷淋 开关
				.antMatchers("/ssdevice/device/projectSpray/deviceOperation")

				//扬尘页面获取喷淋状态
				.antMatchers("/ssdevice/device/projectSpray/getSpraysByEnvironDevice")

				.antMatchers("/ssdevice/project/alarmInfo/getAlarmAccount")
