...
import com.xywg.equipmentmonitor.modular.device.service.ProjectElectricPowerAlarmService;
 ...
 */
@RestController
@RequestMapping("ssdevice/project/projectElectricPowerAlarm")
public class ProjectElectricPowerAlarmController extends BaseController<ProjectElectricPowerAlarm, ProjectElectricPowerAlarmService> {
    ...
    ResultDTO<DataDTO<List<ProjectElectricPowerAlarm>>> selectPageList(@RequestBody RequestDTO<ProjectElectricPowerAlarm> res) {
    ...
    ResultDTO<DataDTO<List<ProjectElectricPowerAlarm>>> countAlarmByDeviceNoDetail(@RequestBody RequestDTO<CountAlarmByDeviceNo> res) {
