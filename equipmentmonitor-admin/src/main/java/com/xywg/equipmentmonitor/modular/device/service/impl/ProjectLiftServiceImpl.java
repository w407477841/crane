...
import com.xywg.equipmentmonitor.modular.device.dao.ProjectLiftVideoMapper;
...
import com.xywg.equipmentmonitor.modular.infromation.service.impl.ProjectTargetSetLiftServiceImpl;
...
public class ProjectLiftServiceImpl extends ServiceImpl<ProjectLiftMapper, ProjectLift> implements IProjectLiftService {
    ...
    public ResultDTO<DataDTO<List<ProjectLiftVO>>> selectPageList(RequestDTO<ProjectLiftVO> res) {
        ...
        {
            wrapper.like("a.device_no",res.getDeviceNo());
        }
    ...
    @Override
    public ResultDTO<Object> updateDispatch(RequestDTO<ProjectLift> res) {
        ...
        {
            Integer id = Integer.valueOf(res.getIds().get(i).toString());
            ProjectLift lift=baseMapper.selectById(id);
            String deviceNo=lift.getDeviceNo();
            redisUtil.set("xywg:sjj:dispatch:"+deviceNo,1);
        }
