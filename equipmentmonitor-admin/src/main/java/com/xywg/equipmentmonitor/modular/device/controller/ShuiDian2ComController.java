...
import com.xywg.equipmentmonitor.modular.device.service.IShuiDian2ComService;
...
@GetMapping("waterLineChart")
     ...
     * @return
     */
    @GetMapping("tongbihuanbi")
    public ResultDTO tobihuanbi(@RequestParam(value = "uuid")String uuid){
        Map<String,Object> data = new HashMap<>(8);
        Map<String,Object> shuibiao = new HashMap<>(8);
        Map<String,Object> dianbiao  = new HashMap<>(8);
        shuibiao.put("tb",105);
        shuibiao.put("hb",5);
        dianbiao.put("tb",80);
        dianbiao.put("hb",10);
        data.put("sb",shuibiao);
        data.put("db",dianbiao);
