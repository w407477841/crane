package com.xingyun.equipment.simpleequipment.receive.modular.envmon.factory;
...
*/
    public static List<ProjectEnvironmentMonitorAlarm> factory(XywgProerties monitor, ProjectEnvironmentMonitorDetail detail){
