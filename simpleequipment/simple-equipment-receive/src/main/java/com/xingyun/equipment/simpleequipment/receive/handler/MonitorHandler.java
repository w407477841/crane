...
import com.xingyun.equipment.simpleequipment.receive.crane.CraneBusinessLogicService;
import com.xingyun.equipment.simpleequipment.receive.crane.CraneHandlerService;
import com.xingyun.equipment.simpleequipment.receive.dust.DustHandlerService;
...
import static com.xingyun.equipment.simpleequipment.core.CommonStaticMethod.*;
import static com.xingyun.equipment.simpleequipment.core.Const.*;
...
//        }
    ...
    private void switchAnalysisProtocol(ChannelHandlerContext ctx, String restDataString, String sn) {
        ...
        switch (deviceType) {
            ...
            //塔机
            case "03":
                craneHandlerService.dataProtocol(ctx, restDataString, sn);
                break;
            //智能安全帽
            case "04":
                break;
