...
import com.xingyun.equipment.crane.modular.device.vo.CraneAPIVO;
import com.xingyun.equipment.crane.modular.device.vo.EnviromentAPIVO;
 ...
 */
@RestController
@RequestMapping("admin-crane/crane")
