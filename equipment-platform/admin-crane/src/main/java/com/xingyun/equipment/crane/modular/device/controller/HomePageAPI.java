...
@PostMapping("admin-crane/homepage/craneAlarmCount")
     ...
     * @return
     */
    @PostMapping("admin-crane/homepage/craneNotice")
     ...
     * @return
     */
    @PostMapping("admin-crane/homepage/billboard")
    ...
    @ApiOperation("获取天气信息")
    @GetMapping("admin-crane/homepage/getWeatherInfo")
