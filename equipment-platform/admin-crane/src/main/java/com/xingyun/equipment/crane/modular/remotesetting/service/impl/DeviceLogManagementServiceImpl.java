...
import com.xingyun.equipment.crane.modular.remotesetting.dao.DeviceLogManagementMapper;
...
import com.xingyun.equipment.crane.modular.remotesetting.service.DeviceLogManagementService;
...
public class DeviceLogManagementServiceImpl implements DeviceLogManagementService {
    ...
    public ResultDTO<Object> deviceReboot(RequestDTO<List<DeviceLogInfo>> request) {
        ...
        String url = "http://" + iotUrl + "/admin-crane/activeIssued/rebootDevice";
        //通知设备
