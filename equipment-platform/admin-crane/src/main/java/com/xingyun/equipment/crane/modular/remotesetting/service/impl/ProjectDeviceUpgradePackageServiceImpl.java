...
import com.xingyun.equipment.crane.modular.remotesetting.dao.ProjectDeviceUpgradePackageMapper;
...
import com.xingyun.equipment.crane.modular.remotesetting.service.ProjectDeviceUpgradePackageService;
...
public class ProjectDeviceUpgradePackageServiceImpl extends ServiceImpl<ProjectDeviceUpgradePackageMapper, ProjectDeviceUpgradePackage> implements ProjectDeviceUpgradePackageService {
    ...
    public ResultDTO<Object> insertDeviceUpgrade(Integer id, String ids) {
        ...
        //localhost:9091/admin-crane/activeIssued/upgradePackage
        String url = "http://" + iotUrl + "/admin-crane/activeIssued/upgradePackage";
