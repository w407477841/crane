package com.xingyun.equipment.crane.modular.common.controller;

import static com.xingyun.equipment.crane.core.util.FtpUtil.uploadFile;
...
import com.xingyun.equipment.crane.config.properties.FtpPropteries;
...
import com.xingyun.equipment.crane.core.util.FtpUtil;
import com.xingyun.equipment.crane.modular.common.model.FileUpload;
/**
 * ftp上传
 * @author lw
 * @date 2018年8月21日
 * @company jsxywg
 */
@RequestMapping(value = "/admin-crane/fileUpload")
@Controller
