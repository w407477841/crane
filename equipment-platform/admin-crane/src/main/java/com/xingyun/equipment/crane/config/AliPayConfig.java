...
public class AliPayConfig {
     ...
     */
    public static String NOTIFY_URL = "http://crane.jsxywg.cn/admin-crane/alipay/notifyUrl";

    /**
     * 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
     */
    public static String RETURN_URL = "http://crane.jsxywg.cn/admin-crane/alipay/returnUrl";
