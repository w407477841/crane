package com.xingyun.equipment.websocket.rabbitmq;

import com.baomidou.mybatisplus.mapper.EntityWrapper;
import com.baomidou.mybatisplus.mapper.Wrapper;
import com.xingyun.equipment.websocket.rabbitmq.callback.ConfirmCallbackHandler;
import com.xingyun.equipment.websocket.rabbitmq.callback.ErrorCallbackHandler;
import com.xingyun.equipment.websocket.rabbitmq.model.MqBinding;
import com.xingyun.equipment.websocket.rabbitmq.model.MqExchange;
import com.xingyun.equipment.websocket.rabbitmq.model.MqQueue;
...
public class RabbitConfig {
    ...
    public final static String [][] CRANE_BINDINGDS = {
            {"queue.websocket","topic.websocket"}
    };
...
//        queues.add(mqQueue);
        ...
        map.put("queueName",CRANE_BINDINGDS[0][0]);
        map.put("exchangeName",CRANE_EXCHANGE);
        map.put("routing",CRANE_BINDINGDS[0][1]);
        map.put("type","topic");
        bindings.add(map);
