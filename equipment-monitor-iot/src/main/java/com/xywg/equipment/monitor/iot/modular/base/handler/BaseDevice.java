...
public abstract class BaseDevice {
    ...
    public  void handler(String data, ZbusProducerHolder producerHolder, MasterProtocolConfigDTO config){
		...
		try{
			doBusiness(data,producerHolder,config);
		}catch (Exception e){
e.printStackTrace();
		}
	}
	 ...
	 *
	 * @param data  原始数据
	 * @param producerHolder  zbus
	 * @param config  协议配置
	 */
	@Transactional(rollbackFor = {Exception.class})
	public abstract void doBusiness(String data, ZbusProducerHolder producerHolder, MasterProtocolConfigDTO config);
