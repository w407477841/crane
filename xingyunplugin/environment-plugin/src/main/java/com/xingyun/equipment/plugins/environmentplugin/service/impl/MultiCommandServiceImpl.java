 ...
 * @author : wangyifei
 * Description
 * Date: Created in 16:49 2019/7/10
 * Modified By : wangyifei
 */
@Slf4j
public class MultiCommandServiceImpl extends BaseCommandService {


    public MultiCommandServiceImpl(CommandCallback callback) {
        super(callback);
    }

    @Override
    public void commandExec(ProtocolDTO protocolDTO, ChannelHandlerContext ctx) {
        log.info(LogEnum.COMMON.format("多机防碰撞:",protocolDTO.toString()));
        this.callback.multiCallback(protocolDTO);
