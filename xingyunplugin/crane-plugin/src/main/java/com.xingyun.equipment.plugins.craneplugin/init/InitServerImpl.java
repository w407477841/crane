package com.xingyun.equipment.plugins.craneplugin.init;
...
import com.xingyun.equipment.plugins.craneplugin.AutoConfigCranePlugin;
...
public class InitServerImpl implements InitServer {
    ...
    public void open() {
        try {
            AutoConfigCranePlugin.getBean(CommandCallback.class);
        }catch (Exception e){
