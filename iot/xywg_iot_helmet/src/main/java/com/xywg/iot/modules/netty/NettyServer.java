package com.xywg.iot.modules.netty;


import com.xywg.iot.modules.netty.handler.ChannelInit;
...
public class NettyServer {
    @Value("${xywg.helmet-port}")
    private String helmetPort;
    @Autowired
    ...
    private void portServer() throws InterruptedException {
        ...
        try {
            ...
            String[] portArray = helmetPort.split(",");
