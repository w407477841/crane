...
public class ChannelInit extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch) {
        ...
        pipeline.addLast(new IdleStateHandler(60*15, 0, 0, TimeUnit.SECONDS));
        /*
         * 重要参数说明:
         * 第一个参数:报文允许的最大长度
         ...
         */
        pipeline.addLast(new LengthFieldBasedFrameDecoder(1024 * 2, 1, 1, 0, 0));
        // 具体处理器 真正的数据处理
        pipeline.addLast(helmetHandler);
    }
}
