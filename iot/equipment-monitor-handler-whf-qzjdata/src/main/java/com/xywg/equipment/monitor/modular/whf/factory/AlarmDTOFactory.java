...
*/
     ...
     * Date: 9:47 2018/8/28
     */
    public static AlarmDTO factory(DeviceAlarm alarm, ProjectInfo project, String deviceType, ProjectCraneDetail crane,String name){
        ...
        alarmDTO.setUuid(project.getUuid());
        alarmDTO.setInfo(alarm.getAlarmInfo());
        alarmDTO.setValue(getValue(alarm,crane));
        alarmDTO.setName(name);
        return alarmDTO;
    }

    public static  String factoryMessage(DeviceAlarm alarm, ProjectInfo project,String deviceType,ProjectCraneDetail crane,String name){
    ...
    private static String  getValue(DeviceAlarm alarm,ProjectCraneDetail crane){
        String  value = "";
        switch (alarm.getAlarmId()){
            case 1 :
            case 2 :
                value=crane.getWeight()+" T";
                break ;
            case 3 :
            case 4 :
            case 5 :
            case 6 :
                value=crane.getRange()+" m";
                break;
            case 7 :
            case 8 :
                value=crane.getHeight()+" m";
                break;
            case 9 :
            case 10:
                value=crane.getMoment()+" N.m";
                break;
            case 15 :
                value=crane.getWindSpeed()+" m/s";
                break;
            case 16 :
                value=crane.getTiltAngle()+" °";
                break;
        }
        return value ;
    }
