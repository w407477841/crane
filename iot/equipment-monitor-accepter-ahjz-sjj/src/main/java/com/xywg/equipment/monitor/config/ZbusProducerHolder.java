...
public class ZbusProducerHolder {
    ...
    private Producer sjjImgProducer;
    ...
    public void init(String host) {
        try {
            ...
            //初始化 升降机上传图像
            sjjImgProducer =new Producer(broker);
            sjjImgProducer.declareTopic(zbusConfig.getSjjImgTopic());
     ...
     * @throws Exception
     */
    public void sendSjjImgMessage(String data) throws Exception{
        Message msg=new Message();
        msg.setHeader("server",serverProperties.getName());
        msg.setBody(data);
        msg.setTopic(zbusConfig.getSjjImgTopic());
        sjjImgProducer.publish(msg);
    }
    ...
    public void sendTestMessage(String sn ,String data) throws Exception{
        Message msg=new Message();
        msg.setHeader("Device-Type","lift");
